...
func swiftlexerLexerInit() {
	...
	staticData.serializedATN = []int32{
		...
		0, 0, 0, 1, 69, 1, 0, 0, 0, 3, 73, 1, 0, 0, 0, 5, 79, 1, 0, 0, 0, 7, 84,
		1, 0, 0, 0, 9, 89, 1, 0, 0, 0, 11, 95, 1, 0, 0, 0, 13, 101, 1, 0, 0, 0,
		15, 104, 1, 0, 0, 0, 17, 109, 1, 0, 0, 0, 19, 116, 1, 0, 0, 0, 21, 128,
		1, 0, 0, 0, 23, 137, 1, 0, 0, 0, 25, 144, 1, 0, 0, 0, 27, 147, 1, 0, 0,
		0, 29, 150, 1, 0, 0, 0, 31, 152, 1, 0, 0, 0, 33, 155, 1, 0, 0, 0, 35, 158,
		1, 0, 0, 0, 37, 160, 1, 0, 0, 0, 39, 163, 1, 0, 0, 0, 41, 166, 1, 0, 0,
		0, 43, 168, 1, 0, 0, 0, 45, 170, 1, 0, 0, 0, 47, 172, 1, 0, 0, 0, 49, 174,
		1, 0, 0, 0, 51, 176, 1, 0, 0, 0, 53, 178, 1, 0, 0, 0, 55, 180, 1, 0, 0,
		0, 57, 182, 1, 0, 0, 0, 59, 184, 1, 0, 0, 0, 61, 187, 1, 0, 0, 0, 63, 193,
		1, 0, 0, 0, 65, 207, 1, 0, 0, 0, 67, 218, 1, 0, 0, 0, 69, 70, 5, 105, 0,
		0, 70, 71, 5, 110, 0, 0, 71, 72, 5, 116, 0, 0, 72, 2, 1, 0, 0, 0, 73, 74,
		5, 102, 0, 0, 74, 75, 5, 108, 0, 0, 75, 76, 5, 111, 0, 0, 76, 77, 5, 97,
		0, 0, 77, 78, 5, 116, 0, 0, 78, 4, 1, 0, 0, 0, 79, 80, 5, 98, 0, 0, 80,
		81, 5, 111, 0, 0, 81, 82, 5, 111, 0, 0, 82, 83, 5, 108, 0, 0, 83, 6, 1,
		0, 0, 0, 84, 85, 5, 116, 0, 0, 85, 86, 5, 114, 0, 0, 86, 87, 5, 117, 0,
		0, 87, 88, 5, 101, 0, 0, 88, 8, 1, 0, 0, 0, 89, 90, 5, 102, 0, 0, 90, 91,
		5, 97, 0, 0, 91, 92, 5, 108, 0, 0, 92, 93, 5, 115, 0, 0, 93, 94, 5, 101,
		0, 0, 94, 10, 1, 0, 0, 0, 95, 96, 5, 112, 0, 0, 96, 97, 5, 114, 0, 0, 97,
		98, 5, 105, 0, 0, 98, 99, 5, 110, 0, 0, 99, 100, 5, 116, 0, 0, 100, 12,
		1, 0, 0, 0, 101, 102, 5, 105, 0, 0, 102, 103, 5, 102, 0, 0, 103, 14, 1,
		0, 0, 0, 104, 105, 5, 101, 0, 0, 105, 106, 5, 108, 0, 0, 106, 107, 5, 115,
...
const (
	...
	SwiftLexerWHITESPACE   = 31
	SwiftLexerCOMMENT      = 32
	SwiftLexerLINE_COMMENT = 33
)
